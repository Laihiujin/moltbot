...
const DEFAULT_AGENT_LOGO_URL =
  "data:image/svg+xml,%3Csvg viewBox='0 0 120 120' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cdefs%3E%3ClinearGradient id='lobster-gradient' x1='0%25' y1='0%25' x2='100%25' y2='100%25'%3E%3Cstop offset='0%25' stop-color='%23ff4d4d'/%3E%3Cstop offset='100%25' stop-color='%23991b1b'/%3E%3C/linearGradient%3E%3C/defs%3E%3Cpath d='M60 10 C30 10 15 35 15 55 C15 75 30 95 45 100 L45 110 L55 110 L55 100 C55 100 60 102 65 100 L65 110 L75 110 L75 100 C90 95 105 75 105 55 C105 35 90 10 60 10Z' fill='url(%23lobster-gradient)'/%3E%3Cpath d='M20 45 C5 40 0 50 5 60 C10 70 20 65 25 55 C28 48 25 45 20 45Z' fill='url(%23lobster-gradient)'/%3E%3Cpath d='M100 45 C115 40 120 50 115 60 C110 70 100 65 95 55 C92 48 95 45 100 45Z' fill='url(%23lobster-gradient)'/%3E%3Cpath d='M45 15 Q35 5 30 8' stroke='%23ff4d4d' stroke-width='3' stroke-linecap='round'/%3E%3Cpath d='M75 15 Q85 5 90 8' stroke='%23ff4d4d' stroke-width='3' stroke-linecap='round'/%3E%3Ccircle cx='45' cy='35' r='6' fill='%23050810'/%3E%3Ccircle cx='75' cy='35' r='6' fill='%23050810'/%3E%3Ccircle cx='46' cy='34' r='2.5' fill='%2300e5cc'/%3E%3Ccircle cx='76' cy='34' r='2.5' fill='%2300e5cc'/%3E%3C/svg%3E";

export function agentLogoUrl(basePath: string): string {
  const base = normalizeOptionalString(basePath)?.replace(/\/$/, "") ?? "";
  return base ? `${base}/favicon.svg` : DEFAULT_AGENT_LOGO_URL;
}
